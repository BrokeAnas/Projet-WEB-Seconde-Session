...
@Component({
  selector: 'app-paiement-form-page',
  imports: [
    ReactiveFormsModule, MatDialogModule, MatFormFieldModule, MatInputModule,
    MatSelectModule, MatAutocompleteModule, MatButtonModule
  ],
  templateUrl: './paiement-form-page.component.html',
  styleUrl: './paiement-form-page.component.scss'
})
export class PaiementFormPageComponent implements OnInit {
  private readonly fb = inject(FormBuilder);
  private readonly destroyRef = inject(DestroyRef);
  readonly patientService = inject(PatientService);
  private readonly paiementService = inject(PaiementService);
  private readonly dialogRef = inject(MatDialogRef<PaiementFormPageComponent>);
