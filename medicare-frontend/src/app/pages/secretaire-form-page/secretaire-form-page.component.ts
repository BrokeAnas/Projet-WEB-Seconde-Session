...
@Component({
  selector: 'app-secretaire-form-page',
  imports: [
    ReactiveFormsModule, MatDialogModule, MatFormFieldModule, MatInputModule,
    MatSelectModule, MatButtonModule
  ],
  templateUrl: './secretaire-form-page.component.html',
  styleUrl: './secretaire-form-page.component.scss'
})
export class SecretaireFormPageComponent implements OnInit {
  private readonly fb = inject(FormBuilder);
  private readonly secretaireService = inject(SecretaireService);
  readonly sucursaleService = inject(SucursaleService);
  private readonly dialogRef = inject(MatDialogRef<SecretaireFormPageComponent>);
